        ...
        return (
            <div className="progressBar-container">
                <div className="progressBar">
                    ...
                    <div>
                        <div className="preview" hidden={hoverPreview != true} onMouseOver = {showPreview} onMouseOut = {() => this.setState({hoverPreview: false})}>
                            {/* <img hidden={hoverPreview != true} className='questionImg' src={flagToImg(value[1])}  /> */}
                            <div hidden={hoverPreview != true} style={{color: 'grey'}}>Flagged at {formatTime(value[1])}</div>
                        </div>
