        ...
        return (
            <div className="Home">
                ...
                <Row className="split-left"  tabIndex="1">
                    ...
                    centerY={1000}
                    >
                    <Slice>k<FontAwesomeIcon icon="home" size="2x" /></Slice>
                    <Slice>"a"</Slice>
                    <Slice>"b"</Slice>
                    ...
                    <Slice >"d"</Slice>
                    <Slice onSelect={() => window.open('https://www.facebook.com', '_blank')}>
                        f<FontAwesomeIcon icon="facebook-f" size="2x" />
                    </Slice>


                    <Slice onSelect={() => window.open('https://www.twitter.com', '_blank')}>
                        g<FontAwesomeIcon icon="twitter" size="2x" />
                    </Slice>

                    <Slice onSelect={() => window.open('https://www.linkedin.com', '_blank')}>
                        h<FontAwesomeIcon icon="linkedin-in" size="2x" />
                    </Slice>
                    <Slice>"e"</Slice>
                    <Slice>"c"</Slice>
                    </PieMenu>
