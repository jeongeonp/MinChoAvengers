...
export default class Timeline extends React.Component {
    ...
    flagClickHandler(index){
        //here
        console.log("flag index is here");
    }
    ...
    render() {
        ...
        return (
            ...
            {flags.map((value) => <Clickable onClick={() => this.flagClickHandler(value)}><div className="flag-tip" key={value} style={{left: value/videoTime*100+"%"}}>🚩 </div></Clickable>)}
