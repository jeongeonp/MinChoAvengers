    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <Row className="split-left"  >
                    <Row className="main-video">
                    <ReactPlayer ref={this.ref} playing={playing}
                    playbackRate={playbackRate} id="video"  width="auto" height="100%" controls url = {'https://www.youtube.com/watch?v=rj_YjNakQ5k'} onPause={this._onPause}
                    onPlay={this._onPlay}
